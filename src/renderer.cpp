...
Renderer::Orientation Renderer::Direction(SDL_Point p1, SDL_Point p2)
{ 
    if (p1.y < p2.y)
...
Renderer::Orientation Renderer::Direction(int xpos1, int ypos1, int xpos2, int ypos2)
{
    if (ypos1 < ypos2)
        return Orientation::Up;
    else if (ypos1 > ypos2)
...
void Renderer::RenderBlock(Orientation dir, int x, int y, SDL_Rect &block)
{ 
    switch (dir)
    {
    case Orientation::Up:
